...
const decorateHyper = (Hyper, { React }) => class extends React.Component {
    constructor(props, context) {
        super(props, context);
    }

    componentDidMount() {
        const { sessionCount, onThemeUpdated } = this.props;
        this.hyperMain = document.getElementsByClassName('hyper_main')[0];
        updateHyperSessions(this.hyperMain, sessionCount);
        window.rpc.on('theme:updated', ({ theme, focus }) => onThemeUpdated(theme, focus));
    }
